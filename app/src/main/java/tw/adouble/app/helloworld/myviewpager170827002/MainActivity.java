package tw.adouble.app.helloworld.myviewpager170827002;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initViewPager(){
        ...
        flipper = (ViewFlipper) view2.findViewById(R.id.flipper);//從View2找出flipper
        ...
        pager.setOnPageChangeListener(new MyPagerListenter());
        pager.setCurrentItem(1);//預設停在第一頁
    ...
    private class MyPagerAdapter extends PagerAdapter{
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View view = views.get(position);//要秀哪個找給你
            pager.addView(view);
    ...
    private class MyPagerListenter extends ViewPager.SimpleOnPageChangeListener{
        @Override
